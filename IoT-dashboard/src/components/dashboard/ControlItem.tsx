	...
	return (
		<div
			...
			<div className="flex-1 min-w-0 ml-3 sm:ml-[18px]">
				<span className="block text-[0.9rem] sm:text-[1rem] font-semibold truncate">
					{label}
				</span>
			...
			{sliderValue !== undefined ? (
				...
				<label
					className={`toggle-switch ${toggleColor} relative inline-block w-[52px] sm:w-[56px] h-[28px] sm:h-[30px] shrink-0`}>
					<input
						type="checkbox"
						checked={checked}
						onChange={onToggle}
